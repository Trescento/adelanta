<template>
  <div class="rounded-3xl flex flex-col lg:flex-row bg-white overflow-hidden">
    <div class="w-full h-72 lg:w-1/2 lg:h-auto relative">
      <img :src="post.image" alt="Blog Hero Image" class="absolute top-0 bottom-0 left-0 right-0 w-full h-full object-cover">
    </div>
    <div class="flex flex-col p-6 gap-6 lg:w-1/2">
      ...
      <CommonBaseButton type="ghost" as-anchor :href="post.slug">
