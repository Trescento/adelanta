<template>
  ...
  <section class="block md:hidden my-24 container">
    ...
    >
      ...
      >
        <button class="rounded-full bg-brand w-8 h-8 flex items-center justify-center" @click="previousTestimonial">
          <svg
        ...
        <button class="rounded-full bg-brand w-8 h-8 flex items-center justify-center" @click="nextTestimonial">
