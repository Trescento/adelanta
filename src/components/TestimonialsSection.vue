<template>
  ...
  <section class="block md:hidden my-24 container">
    ...
    >
      <div
        class="flex gap-4 my-24 items-center"
      ...
      >
        <button @click="previousTestimonial" class="rounded-full bg-brand w-8 h-8 flex items-center justify-center">
        ...
        <div
          class="flex-1 border rounded-3xl px-8 gap-2 flex flex-col pb-8"
        >
          <img src="~/assets/testimonials.png" alt="" class="rounded-full h-28 w-28 mx-auto -mt-14">
          <p class="text-lg pt-2">{{ testimonial.name }}</p>
          <p class="text-lg font-semibold">{{ testimonial.role }}</p>
          <p class="text-sm">{{ testimonial.text }}</p>
        </div>
        <button @click="nextTestimonial" class="rounded-full bg-brand w-8 h-8 flex items-center justify-center">
  ...
  <section class="hidden md:block container my-24">
    <div class="flex flex-col">
      ...
      >
        ...
        >
          <p class="font-bold text-[2.5rem] text-center max-w-5xl mx-auto my-10">{{ testimonial.text }}</p>
          ...
          <div class="flex justify-between">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p class="text-lg">{{ testimonial.role }}</p>
              </div>
            </div>
            <div class="flex items-center gap-4">
              <button @click="previousTestimonial" class="rounded-full bg-brand w-8 h-8 flex items-center justify-center">
